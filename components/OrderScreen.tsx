...
import { ShoppingBag, Plus, Minus, Trash2, ShieldCheck, ArrowRight, Sparkles } from 'lucide-react';
    ...
    <div className="px-4 py-4 space-y-4 pb-12">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-slate-500">Review selected services before checkout</p>
        </div>
      ...
      <div className="space-y-2.5">
        {cart.map(({ product, quantity }) => (
          <div
            key={product.id}
            className="p-3 bg-white rounded-2xl border border-slate-200/80 shadow-xs flex items-center justify-between gap-3 transition-all hover:shadow-md"
          >
            {/* Logo */}
            <div className="w-12 h-12 relative rounded-xl bg-slate-50 p-1 border border-slate-100 flex items-center justify-center shrink-0">
              <Image
      ...
      <div className="p-4 bg-white rounded-2xl border border-slate-200/80 shadow-xs space-y-2.5">
        ...
        <div className="flex items-center justify-between text-xs text-slate-600">
          <span>Instant Processing Fee</span>
