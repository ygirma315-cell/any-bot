...
import { 
  ...
  RefreshCw, Check, ArrowUp, ArrowDown, Database, Info, ArrowUpDown
} from 'lucide-react';
...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({ onLogout }) => {
  ...
  const handleReorderProducts = (reordered: Product[]) => {
    ...
    saveStoredProducts(reordered, true);
    setHeaderToast('✨ Product ranking & order saved successfully!');
  ...
  return (
    <div className="min-h-screen w-full bg-[#F6F8FB] text-slate-900 flex font-sans overflow-x-hidden relative">
                ...
                <div className="flex items-center justify-between gap-3 flex-wrap">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="px-3.5 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-black rounded-xl border border-slate-200 transition-all flex items-center gap-1.5 shadow-2xs"
                      title="Reorder and sort how products appear on the store"
                    >
                    ...
                    <button
                      ...
                      className="px-4 py-2 bg-[#FF6B00] hover:bg-[#E66000] text-white text-xs font-black rounded-xl shadow-xs transition-all flex items-center gap-1.5 active:scale-95"
                    >
      ...
      {/* Product Sort & Rank Modal */}
      <ProductSortModal
        isOpen={isSortModalOpen}
        products={products}
        onSave={handleReorderProducts}
