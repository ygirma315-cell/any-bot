...
export const AdminSettingsView: React.FC = () => {
  ...
  const [testEmailInput, setTestEmailInput] = useState<string>('ygirma315@gmail.com');
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  placeholder="Enter recipient email (e.g. ygirma315@gmail.com)..."
          ...
          <div className="space-y-2 text-xs">
            ...
            <div className="flex items-center justify-between p-2.5 bg-slate-800/90 rounded-xl border border-slate-700 font-mono text-[11px]">
              <span className="text-emerald-400 truncate mr-2">
                https://aiunlimited.shop/api/debug?testEmail={testEmailInput || 'ygirma315@gmail.com'}
              </span>
              <button
                type="button"
                onClick={() => handleCopyLink(`https://aiunlimited.shop/api/debug?testEmail=${testEmailInput || 'ygirma315@gmail.com'}`, 'debug')}
            ...
            <div className="flex items-center justify-between p-2.5 bg-slate-800/90 rounded-xl border border-slate-700 font-mono text-[11px]">
              <span className="text-orange-400 truncate mr-2">
                https://aiunlimited.shop/api/test-email?to={testEmailInput || 'ygirma315@gmail.com'}
              </span>
              <button
                type="button"
                onClick={() => handleCopyLink(`https://aiunlimited.shop/api/test-email?to=${testEmailInput || 'ygirma315@gmail.com'}`, 'test-email')}
                className="px-2.5 py-1 bg-slate-700 hover:bg-slate-600 text-white rounded-lg font-sans font-bold text-[10.5px] transition shrink-0 flex items-center gap-1"
              >
                <Copy className="w-3 h-3" />
