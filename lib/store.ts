...
const DEFAULT_STORAGE_ITEMS: ProductStorageItem[] = [
  { id: 'stock-chatgpt-1', product_id: 'chatgpt-plus', type: 'account', link: 'https://chatgpt.com', username: 'demo.user@example.com', password: 'REPLACE_ME', notes: '1. Go to https://chatgpt.com\n2. Click Log In and enter this email & password\n3. Select GPT-4o model and enjoy your subscription!', is_used: false },
  { id: 'stock-chatgpt-2', product_id: 'chatgpt-plus', type: 'account', link: 'https://chatgpt.com', username: 'demo.user2@example.com', password: 'REPLACE_ME', notes: '1. Log in at https://chatgpt.com with provided email and password.\n2. Access GPT-4o, DALL-E 3, and Canvas.', is_used: false },
  { id: 'stock-chatgpt-3', product_id: 'chatgpt-plus', type: 'account', link: 'https://chatgpt.com', username: 'demo.user3@example.com', password: 'REPLACE_ME', notes: 'Log in at chatgpt.com with credentials. Full 20-day warranty active.', is_used: false },
  { id: 'demo-gemini', product_id: 'gemini-pro', type: 'account', link: 'https://gemini.google.com', username: 'demo.user@example.com', password: 'REPLACE_ME', notes: 'Access Google Gemini Advanced with full 1M context. Enjoy your AI tools!', is_used: false },
  { id: 'demo-claude', product_id: 'claude-pro', type: 'account', link: 'https://claude.ai', username: 'demo.user@example.com', password: 'REPLACE_ME', notes: 'Log in at claude.ai with provided credentials to access Claude 3.5 Sonnet & Artifacts.', is_used: false },
  { id: 'demo-perplexity', product_id: 'perplexity-pro', type: 'account', link: 'https://perplexity.ai', username: 'demo.user@example.com', password: 'REPLACE_ME', notes: 'Full Perplexity Pro AI Search with unlimited queries and model selection.', is_used: false },
  { id: 'demo-canva', product_id: 'canva-pro', type: 'account', link: 'https://canva.com', username: 'demo.user@example.com', password: 'REPLACE_ME', notes: 'Log in at canva.com to access full Magic Studio and Pro asset library.', is_used: false },
  { id: 'demo-capcut', product_id: 'capcut-pro', type: 'account', link: 'https://capcut.com', username: 'demo.user@example.com', password: 'REPLACE_ME', notes: 'Log in on CapCut PC or Mobile to unlock 4K export and Pro transitions.', is_used: false },
  { id: 'demo-copilot', product_id: 'copilot-pro', type: 'account', link: 'https://copilot.microsoft.com', username: 'demo.user@example.com', password: 'REPLACE_ME', notes: 'Microsoft Copilot Pro subscription active for Office & GPT-4 Turbo reasoning.', is_used: false },
  { id: 'demo-youtube', product_id: 'youtube-premium', type: 'account', link: 'https://youtube.com/premium', username: 'demo.user@example.com', password: 'REPLACE_ME', notes: 'Ad-free streaming, YouTube Music, and background playback active.', is_used: false },
  { id: 'demo-midjourney', product_id: 'midjourney-v6', type: 'account', link: 'https://midjourney.com', username: 'demo.user@example.com', password: 'REPLACE_ME', notes: 'Log in via Midjourney/Discord to generate photorealistic v6 art.', is_used: false },
  { id: 'demo-notion', product_id: 'notion-ai', type: 'account', link: 'https://notion.so', username: 'demo.user@example.com', password: 'REPLACE_ME', notes: 'Notion AI Workspace active. Enjoy automated AI document summarization.', is_used: false },
];
